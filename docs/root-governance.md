# Root Governance: Neo4j-Knowledge-Base

Dokumen ini memuat aturan tingkat root untuk monorepo **Neo4j Knowledge Base**.
...
- `.cursorrules`: Sebagai hukum interaksi AI khusus Neo4j.
...
- Konvensi penomoran & AI Persona (Graph Database Specialist).
